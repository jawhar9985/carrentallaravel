...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark" aria-label="Main navigation">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Agence de location de voitures</a>
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="/voitures">Admin Crud (admin)</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="">Louer une voiture (utilisateur)</a>
        </li>
        <li class="nav-item">
